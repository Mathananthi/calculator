...
body {
    ...
    align-items: center;
    height: 100vh;
    background: linear-gradient(to right, #00f7ff, #072122);
    margin: 0;
...
```
### OUTPUT:
![Screenshot (41)](https://github.com/Mathananthi/calculator/assets/135731816/77e5a737-5ef8-4061-97f6-0aea3cc3fd88)
